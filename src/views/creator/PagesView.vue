<template>
  <div class="pages-view container mx-auto px-4 py-8">
    <h1 class="text-3xl font-bold mb-6">Design Your Book Pages</h1>
    
    <CreatorNavigation currentStep="strony" />

    <div class="pages-container">
      <p class="text-gray-600 mb-6">Customize each page of your book.</p>
      ...
      <div class="navigation mt-8 flex justify-between">
        <button @click="router.push('/kreator/historia')" class="px-4 py-2 border rounded">
          Back to Story
        </button>
...
onMounted(() => {
  ...
  // If story questions are not complete, redirect back
...
const finishBook = async () => {
  if (isBookComplete.value) {
    ...
    router.push('/kreator/podsumowanie')
  } else {
